...
public class ForkBlur extends RecursiveAction {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BufferedImage blurredImageNonConcurrent=blur(image);

        String dstNameNonConcurrent="blurred-tulips-nonconcurrent.jpg";
        File dstFileNonConcurrent=new File(dstName);
        ImageIO.write(blurredImage,"jpg",dstFile);
